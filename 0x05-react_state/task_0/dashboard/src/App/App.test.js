...
describe("App tests", () => {
  ...
  // Add a test to verify default state
  it("has default state for displayDrawer as false", () => {
    const wrapper = shallow(<App />);
    expect(wrapper.state("displayDrawer")).toBe(false);
  });

  // Add a test to verify handleDisplayDrawer function
  it("updates displayDrawer to true when handleDisplayDrawer is called", () => {
    const wrapper = shallow(<App />);
    wrapper.instance().handleDisplayDrawer();
    expect(wrapper.state("displayDrawer")).toBe(true);
  });

  // Add a test to verify handleHideDrawer function
  it("updates displayDrawer to false when handleHideDrawer is called", () => {
    const wrapper = shallow(<App />);
